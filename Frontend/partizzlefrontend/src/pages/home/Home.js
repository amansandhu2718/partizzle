      ...
      >
        <div className="carousel-inner">
          <div className="carousel-item active pblack">
            <div className="p-3">
              <div style={{position: "relative"}} className="hg">
                <img src={Cur} className="imh img-fluid" />
                <div
                  style={{position: "absolute",top: "0", width: "100%", height:" 100%"}}
                >
                  <div className="cen" style={{width: "100%", height: "100%"}}>
                    <div className="cen">
          ...
          <div className="carousel-item pblack">
            <div className="p-3">
              <div style={{position: "relative"}} className="hg">
                <img src={Cur1} className="imh img-fluid" />
                <div
                  style={{position: "absolute" ,top: "0", width: "100%", height: "100%"}}
                >
                  <div className="cen" style={{width: "100%", height: "100%"}}>
          ...
          <div className="carousel-item pblack">
            <div className="p-3">
              <div style={{position: "relative"}} className="hg">
                <img src={Cur3} className="imh img-fluid" />
                <div
                  style={{position: "absolute", top: "0", width: "100%", height: "100%"}}
                >
                  <div className="cen" style={{width: "100%", height: "100%"}}>

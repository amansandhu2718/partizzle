    ...
    <div className="col-lg-4">
      ...
      <div className="card mb-3">
        <div className="card-body">
          ...
          <a className="dark-grey-text d-flex justify-content-between" dataToggle="collapse" href="#collapseExample1"
            ariaExpanded="false" ariaControls="collapseExample1">
